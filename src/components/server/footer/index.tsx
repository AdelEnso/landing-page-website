...
export const Footer = () => {
  return (
    <footer className=" bg-black-bg mt-12">
      <div className="container mx-auto  px-4 py-8 lg:grid lg:grid-cols-3  lg:gap-4 md:flex md:flex-col md:items-end">
        {/* Footer Part 1 */}
        ...
        {/* Footer Part 2 */}
        <div className="lg:text-center md:text-center  lg:mt-0 md:mt-4 flex justify-end  flex-col items-start lg:items-center">
