...
export const TEAMS = [
  {
    name: "Team Blue",
    paragraph:
      "These services ensure a robust security infrastructure that not only defends against current threats but is also equipped to evolve with the changing cybersecurity landscape, providing your organization with a pronounced advantage",
    title: "EnsoLab's Blue",
    desc: "Team services deliver a comprehensive approach to organizational cybersecurity.",
    activtes: [
      {
        title: "Threat Hunting Assessment",
        adv: "Prompt threat detection, reduced vulnerability, and strategic preventive measures.",
...

      {
        ...
        adv: "Anticipatory identification and rectification of vulnerabilities, bolstered security posture, and lower risk of breaches.",
      ...
      },
      {
        ...
        adv: "All-encompassing security overview, minimized attack surface, and heightened readiness against threats.",
      ...
      },
      {
        ...
        adv: "Improved threat detection and response, continuous learning from incidents, and updated threat intelligence.",
      ...
      },
      {
        ...
        adv: "Solidified cloud security, ensured regulatory compliance, and amplified resilience to cyber threats.",
      ...
      },
      {
        ...
        adv: "Empowered cybersecurity team, bespoke training needs, and alignment with industry standards.",
      ...
      },
      {
        ...
        adv: "Enhanced security policies, amplified awareness, ensured business continuity, and efficient incident response.",
      ...
      },
      {
        ...
        adv: "Protection of critical infrastructure, mitigated risks, compliant and secure architectures, and improved cyber skills.",
  ...
  },
  {
    name: "Team Red",
    paragraph:
      "These Red Team services provide your organization with a holistic view of your security posture, uncover potential weaknesses, and offer you the advantage of improving your defenses, ensuring maximum cybersecurity.",
    title: "EnsoLab's Red",
    desc: "Team services offer a robust suite of cybersecurity measures designed to safeguard your organization's digital assets and infrastructure",
    activtes: [
      {
        title: "Threat Hunting Program Development",
        adv: "Improved threat visibility, proactive threat mitigation, and an enhanced cybersecurity posture.",
      ...
      {
        title: "Pen Testing",
        adv: "Proactive vulnerability identification, decreased risk of breaches, and validation of existing security measures.",
        desc: "Simulating cyber-attacks to evaluate the security of an organization's information systems and identifying vulnerabilities before actual hackers do.",
      },
      {
        title: "Infrastructure Testing",
        adv: "Comprehensive security evaluation, reduced attack surface, and improved resilience against threats.",
        desc: " Identifying potential points of attack on an organization's infrastructure, including network testing and cloud security assessments.",
      },
      {
        title: "Network Testing",
        adv: "Protection of critical infrastructure, identification of system vulnerabilities, enhanced system resilience, and improved incident response capabilities.",
